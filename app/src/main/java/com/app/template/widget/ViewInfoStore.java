...
import static com.app.template.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR;
import static com.app.template.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static com.app.template.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static com.app.template.widget.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static com.app.template.widget.ViewInfoStore.InfoRecord.FLAG_POST;
import static com.app.template.widget.ViewInfoStore.InfoRecord.FLAG_PRE;
import static com.app.template.widget.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;
...
public class ViewInfoStore {
     ...
     */
    @VisibleForTesting
    final SimpleArrayMap<RecyclerView.ViewHolder, ViewInfoStore.InfoRecord> mLayoutHolderMap =
            new SimpleArrayMap<>();
    ...
    boolean isDisappearing(RecyclerView.ViewHolder holder) {
        final ViewInfoStore.InfoRecord record = mLayoutHolderMap.get(holder);
    ...
    private RecyclerView.ItemAnimator.ItemHolderInfo popFromLayoutStep(RecyclerView.ViewHolder vh, int flag) {
        ...
        final ViewInfoStore.InfoRecord record = mLayoutHolderMap.valueAt(index);
    ...
    boolean isInPreLayout(RecyclerView.ViewHolder viewHolder) {
        final ViewInfoStore.InfoRecord record = mLayoutHolderMap.get(viewHolder);
    ...
    void removeViewHolder(RecyclerView.ViewHolder holder) {
        ...
        final ViewInfoStore.InfoRecord info = mLayoutHolderMap.remove(holder);
        if (info != null) {
    ...
    static class InfoRecord {
        ...
        static ViewInfoStore.InfoRecord obtain() {
            ViewInfoStore.InfoRecord record = sPool.acquire();
