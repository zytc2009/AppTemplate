...
/**
 * {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller} implementation which uses a {@link LinearInterpolator} until
 ...
 * <p>
 * If the {@link androidx.recyclerview.widget.RecyclerView.LayoutManager} you are using does not implement the
 * {@link androidx.recyclerview.widget.RecyclerView.SmoothScroller.ScrollVectorProvider} interface, then you must override the
...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        ...
        final androidx.recyclerview.widget.RecyclerView.LayoutParams params = (androidx.recyclerview.widget.RecyclerView.LayoutParams)
