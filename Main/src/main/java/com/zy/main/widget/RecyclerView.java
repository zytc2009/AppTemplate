...
import com.zy.main.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    private final RecyclerView.RecyclerViewDataObserver mObserver = new RecyclerView.RecyclerViewDataObserver();

    final RecyclerView.Recycler mRecycler = new RecyclerView.Recycler();
     ...
     * {@link RecyclerView.LayoutManager#onItemsChanged(RecyclerView)} should be called during the subsequent
     * measure/layout.
     *
     * @see #processDataSetCompletelyChanged(boolean)
     */
    ...
    final RecyclerView.ViewFlinger mViewFlinger = new RecyclerView.ViewFlinger();
    ...
    private RecyclerView.ItemAnimator.ItemAnimatorListener mItemAnimatorListener =
            new RecyclerView.ItemAnimatorRestoreListener();
     ...
     */
    @VisibleForTesting
    final List<RecyclerView.ViewHolder> mPendingAccessibilityImportanceChange = new ArrayList<>();
    ...
    private final ViewInfoStore.ProcessCallback mViewInfoProcessCallback =
            new ViewInfoStore.ProcessCallback() {
                @Override
                public void processDisappeared(RecyclerView.ViewHolder viewHolder, @NonNull ItemHolderInfo info,
    ...
    public CharSequence getAccessibilityClassName() {
        return "com.zy.main.widget.RecyclerView";
    }
    ...
    private void initChildrenHelper() {
        mChildHelper = new ChildHelper(new ChildHelper.Callback() {
            ...
            public void attachViewToParent(View child, int index,
                ...
                final RecyclerView.ViewHolder vh = getChildViewHolderInt(child);
                if (vh != null) {
            ...
            public void detachViewFromParent(int offset) {
                ...
                if (view != null) {
                    ...
                    if (vh != null) {
                        ...
                        vh.addFlags(RecyclerView.ViewHolder.FLAG_TMP_DETACHED);
                    }
                }
    ...
    void initAdapterManager() {
        mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() {
            ...
            public RecyclerView.ViewHolder findViewHolder(int position) {
                final RecyclerView.ViewHolder vh = findViewHolderForPosition(position, true);
                if (vh == null) {
                    return null;
                }
     ...
     */
    private void setAdapterInternal(@Nullable RecyclerView.Adapter adapter, boolean compatibleWithPrevious,
     ...
     * {@link #addOnChildAttachStateChangeListener(RecyclerView.OnChildAttachStateChangeListener)}.
     */
    ...
    /**
     * Set a {@link RecyclerView.OnFlingListener} for this {@link RecyclerView}.
     * <p>
     * If the {@link RecyclerView.OnFlingListener} is set then it will receive
     * calls to {@link #fling(int,int)} and will be able to intercept them.
     *
     * @param onFlingListener The {@link RecyclerView.OnFlingListener} instance.
     */
    ...
    /**
     * Get the current {@link RecyclerView.OnFlingListener} from this {@link RecyclerView}.
     *
     * @return The {@link RecyclerView.OnFlingListener} instance currently set (can be null).
     */
    @Nullable
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        mPendingSavedState = (RecyclerView.SavedState) state;
    ...
    /**
     * Retrieve this RecyclerView's {@link RecyclerView.RecycledViewPool}. This method will never return null;
     * if no pool is set for this view a new one will be created. See
     * {@link #setRecycledViewPool(RecyclerView.RecycledViewPool) setRecycledViewPool} for more information.
     *
     * @return The pool used to store recycled item views for reuse.
     * @see #setRecycledViewPool(RecyclerView.RecycledViewPool)
     */
    @NonNull
    ...
    /**
     * Sets a new {@link RecyclerView.ViewCacheExtension} to be used by the Recycler.
     *
     * @param extension ViewCacheExtension to be used or null if you want to clear the existing one.
     *
     * @see RecyclerView.ViewCacheExtension#getViewForPositionAndType(RecyclerView.Recycler, int, int)
     */
    ...
    /**
     * Returns the number of {@link RecyclerView.ItemDecoration} currently added to this RecyclerView.
     *
    ...
    /**
     * Remove an {@link RecyclerView.ItemDecoration} from this RecyclerView.
     *
    ...
    /**
     * Sets the {@link RecyclerView.ChildDrawingOrderCallback} to be used for drawing children.
     * <p>
     ...
     * {@link RecyclerView.LayoutManager#smoothScrollToPosition(RecyclerView, RecyclerView.State, int)} and create a
     * {@link RecyclerView.SmoothScroller}.
     * <p>
     * {@link RecyclerView.LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link RecyclerView.LayoutManager#smoothScrollToPosition(RecyclerView, RecyclerView.State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see RecyclerView.LayoutManager#smoothScrollToPosition(RecyclerView, RecyclerView.State, int)
     */
     ...
     * {@link RecyclerView.LayoutManager#scrollHorizontallyBy(int, RecyclerView.Recycler, RecyclerView.State)} and
     * {@link RecyclerView.LayoutManager#scrollVerticallyBy(int, RecyclerView.Recycler, RecyclerView.State)}.
     *
     ...
     * dropped; {@link RecyclerView.LayoutManager#onFocusSearchFailed(View, int, RecyclerView.Recycler, RecyclerView.State)} will not be
     * called.
     *
     * <p>
     * <code>suppressLayout(true)</code> does not prevent app from directly calling {@link
     * RecyclerView.LayoutManager#scrollToPosition(int)}, {@link RecyclerView.LayoutManager#smoothScrollToPosition(
     * RecyclerView, RecyclerView.State, int)}.
     * <p>
     * {@link #setAdapter(RecyclerView.Adapter)} and {@link #swapAdapter(RecyclerView.Adapter, boolean)} will automatically
     * stop suppressing.
     * <p>
     ...
     *   {@link RecyclerView.LayoutManager} must support scrolling in a direction for which the value is not 0.
    ...
    void ensureLeftGlow() {
        ...
        mLeftGlow = mEdgeEffectFactory.createEdgeEffect(this, RecyclerView.EdgeEffectFactory.DIRECTION_LEFT);
        if (mClipToPadding) {
    ...
    void ensureRightGlow() {
        ...
        mRightGlow = mEdgeEffectFactory.createEdgeEffect(this, RecyclerView.EdgeEffectFactory.DIRECTION_RIGHT);
        if (mClipToPadding) {
    ...
    void ensureTopGlow() {
        ...
        mTopGlow = mEdgeEffectFactory.createEdgeEffect(this, RecyclerView.EdgeEffectFactory.DIRECTION_TOP);
        if (mClipToPadding) {
    ...
    void ensureBottomGlow() {
        ...
        mBottomGlow = mEdgeEffectFactory.createEdgeEffect(this, RecyclerView.EdgeEffectFactory.DIRECTION_BOTTOM);
        if (mClipToPadding) {
    ...
    /**
     * Set a {@link RecyclerView.EdgeEffectFactory} for this {@link RecyclerView}.
     * <p>
     * When a new {@link RecyclerView.EdgeEffectFactory} is set, any existing over-scroll effects are cleared
     * and new effects are created as needed using
     * {@link RecyclerView.EdgeEffectFactory#createEdgeEffect(RecyclerView, int)}
     *
     * @param edgeEffectFactory The {@link RecyclerView.EdgeEffectFactory} instance.
     */
...
//        Preconditions.checkNotNull(edgeEffectFactory);
    ...
    /**
     * Retrieves the previously set {@link RecyclerView.EdgeEffectFactory} or the default factory if nothing
     * was set.
     *
     * @return The previously set {@link RecyclerView.EdgeEffectFactory}
     * @see #setEdgeEffectFactory(RecyclerView.EdgeEffectFactory)
     */
    @NonNull
     ...
     * {@link RecyclerView.LayoutManager#onFocusSearchFailed(View, int, RecyclerView.Recycler, RecyclerView.State)} to layout more Views
     ...
     * {@link RecyclerView.LayoutManager#onFocusSearchFailed(View, int, RecyclerView.Recycler, RecyclerView.State)} before running a
    ...
    private void requestChildOnScreen(@NonNull View child, @Nullable View focused) {
        ...
        if (focusedLayoutParams instanceof RecyclerView.LayoutParams) {
            ...
            final RecyclerView.LayoutParams lp = (RecyclerView.LayoutParams) focusedLayoutParams;
            if (!lp.mInsetsDirty) {
     ...
     * returns true from
     * {@link RecyclerView.OnItemTouchListener#onInterceptTouchEvent(RecyclerView, MotionEvent)} its
     * {@link RecyclerView.OnItemTouchListener#onTouchEvent(RecyclerView, MotionEvent)} method will be called
    ...
    /**
     * Remove an {@link RecyclerView.OnItemTouchListener}. It will no longer be able to intercept touch events.
     *
     ...
     *
     * <p>Calls {@link RecyclerView.OnItemTouchListener#onInterceptTouchEvent(RecyclerView, MotionEvent)} on each
     * of the registered {@link RecyclerView.OnItemTouchListener}s, passing in the
    ...
    private boolean findInterceptingOnItemTouchListener(MotionEvent e) {
        ...
        for (int i = 0; i < listenerCount; i++) {
            final RecyclerView.OnItemTouchListener listener = mOnItemTouchListeners.get(i);
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        Log.d("RecyclerView", "whb onMeasure() start");
        if (mLayout == null) {
        ...
        if (mLayout.isAutoMeasureEnabled()) {
            ...
            Log.d("RecyclerView", "whb mLayout.onMeasure() ");
            /**
             * This specific call should be considered deprecated and replaced with
             * {@link #defaultOnMeasure(int, int)}. It can't actually be replaced as it could
             * break existing third party code but all documentation directs developers to not
             * override {@link RecyclerView.LayoutManager#onMeasure(int, int)} when
             * {@link RecyclerView.LayoutManager#isAutoMeasureEnabled()} returns true.
             */
            ...
            if (mState.mLayoutStep == RecyclerView.State.STEP_START) {
                Log.d("RecyclerView", "whb onMeasure() dispatchLayoutStep1() ");
                dispatchLayoutStep1();
            }
            ...
            Log.d("RecyclerView", "whb onMeasure()  dispatchLayoutStep2() ");
            dispatchLayoutStep2();
            ...
            if (mLayout.shouldMeasureTwice()) {
                ...
                mState.mIsMeasuring = true;
                Log.d("RecyclerView", "whb onMeasure()  dispatchLayoutStep2() 2");
                dispatchLayoutStep2();
                // now we can get the width and height from the children.
                mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
            }
            ...
            if (mHasFixedSize) {
                Log.d("RecyclerView", "whb onMeasure() mLayout.onMeasure  mHasFixedSize ");
                mLayout.onMeasure(mRecycler, mState, widthSpec, heightSpec);
                Log.d("RecyclerView", "whb onMeasure() end ");
                return;
            }
            ...
            startInterceptRequestLayout();
            Log.d("RecyclerView", "whb onMeasure() mLayout.onMeasure 2");
            mLayout.onMeasure(mRecycler, mState, widthSpec, heightSpec);
            stopInterceptRequestLayout(false);
     ...
     * {@link RecyclerView.ItemAnimator#animatePersistence(RecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)}
     * DISAPPEARING views are animated via
     * {@link RecyclerView.ItemAnimator#animateDisappearance(RecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)}
     * APPEARING views are animated via
     * {@link RecyclerView.ItemAnimator#animateAppearance(RecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)}
     * and changed views are animated via
     * {@link RecyclerView.ItemAnimator#animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)}.
     */
    void dispatchLayout() {
        Log.d("RecyclerView", "whb dispatchLayout() start ");
        if (mAdapter == null) {
        ...
        if (mState.mLayoutStep == RecyclerView.State.STEP_START) {
            Log.d("RecyclerView", "whb dispatchLayout() dispatchLayoutStep1 ");
            dispatchLayoutStep1();
            mLayout.setExactMeasureSpecsFrom(this);
            Log.d("RecyclerView", "whb dispatchLayout() dispatchLayoutStep2 ");
            dispatchLayoutStep2();
            ...
            // changed size.
            mLayout.setExactMeasureSpecsFrom(this);
            Log.d("RecyclerView", "whb dispatchLayout() dispatchLayoutStep22 ");
            dispatchLayoutStep2();
        } else {
            // always make sure we sync them (to ensure mode is exact)
            mLayout.setExactMeasureSpecsFrom(this);
        }
        Log.d("RecyclerView", "whb dispatchLayout() dispatchLayoutStep3 ");
        dispatchLayoutStep3();
        Log.d("RecyclerView", "whb dispatchLayout() end ");
    }
    ...
    private void saveFocusInfo() {
        ...
        final RecyclerView.ViewHolder focusedVh = child == null ? null : findContainingViewHolder(child);
        if (focusedVh == null) {
            resetFocusInfo();
        } else {
    ...
    private void dispatchLayoutStep1() {
        Log.d("RecyclerView", "whb dispatchLayoutStep1()  start ");
        mState.assertLayoutStep(RecyclerView.State.STEP_START);
        fillRemainingScrollValues(mState);
        mState.mIsMeasuring = false;
        startInterceptRequestLayout();
        ...
        if (mState.mRunSimpleAnimations) {
            ...
            for (int i = 0; i < count; ++i) {
                ...
                Log.d("RecyclerView", "whb dispatchLayoutStep1() addToPreLayout i= "+i);
                ...
                if (mState.mTrackOldChangeHolders && holder.isUpdated() && !holder.isRemoved()
                    ...
                    // change holders list.
                    Log.d("RecyclerView", "whb dispatchLayoutStep1() addToOldChangeHolders  i="+i);
        ...
        if (mState.mRunPredictiveAnimations) {
            ...
            Log.d("RecyclerView", "whb dispatchLayoutStep1() onLayoutChildren()  ");
        ...
        Log.d("RecyclerView", "whb dispatchLayoutStep1() end ");
    }
    ...
    private void dispatchLayoutStep2() {
        Log.d("RecyclerView", "whb dispatchLayoutStep2() start");
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
        ...
        // Step 2: Run layout
        mState.mInPreLayout = false;
        Log.d("RecyclerView", "whb dispatchLayoutStep2() onLayoutChildren()");
        mLayout.onLayoutChildren(mRecycler, mState);
        ...
        onExitLayoutOrScroll();
        stopInterceptRequestLayout(false);
        Log.d("RecyclerView", "whb dispatchLayoutStep2() end");
    }
    ...
    private void dispatchLayoutStep3() {
        Log.d("RecyclerView", "whb dispatchLayoutStep3() start");
        mState.assertLayoutStep(RecyclerView.State.STEP_ANIMATIONS);
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
        ...
        resetFocusInfo();
        Log.d("RecyclerView", "whb dispatchLayoutStep3() end");
    }
    ...
    private void handleMissingPreInfoForChangeError(long key,
                                                    RecyclerView.ViewHolder holder, RecyclerView.ViewHolder oldChangeViewHolder) {
     ...
     */
    void recordAnimationInfoIfBouncedHiddenView(RecyclerView.ViewHolder viewHolder,
                                                ItemHolderInfo animationInfo) {
        // looks like this view bounced back from hidden list!
        viewHolder.setFlags(0, RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
    ...
    void animateAppearance(@NonNull RecyclerView.ViewHolder itemHolder,
    ...
    void animateDisappearance(@NonNull RecyclerView.ViewHolder holder,
    ...
    private void animateChange(@NonNull RecyclerView.ViewHolder oldHolder, @NonNull RecyclerView.ViewHolder newHolder,
                               @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo,
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof RecyclerView.LayoutParams && mLayout.checkLayoutParams((RecyclerView.LayoutParams) p);
    }
    ...
    void saveOldPositions() {
        final int childCount = mChildHelper.getUnfilteredChildCount();
        for (int i = 0; i < childCount; i++) {
            final RecyclerView.ViewHolder holder = getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
     ...
     * {@link RecyclerView.LayoutManager#onItemsChanged(RecyclerView)} during measure/layout.
     */
    ...
    void markKnownViewsInvalid() {
        ...
        for (int i = 0; i < childCount; i++) {
            final RecyclerView.ViewHolder holder = getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
            if (holder != null && !holder.shouldIgnore()) {
                holder.addFlags(RecyclerView.ViewHolder.FLAG_UPDATE | RecyclerView.ViewHolder.FLAG_INVALID);
            }
        }
        markItemDecorInsetsDirty();
    ...
    static RecyclerView.ViewHolder getChildViewHolderInt(View child) {
        ...
        return ((RecyclerView.LayoutParams) child.getLayoutParams()).mViewHolder;
    }
     ...
     * #{@link RecyclerView.ViewHolder#getAdapterPosition()} to get the current adapter position of a ViewHolder.
     * <p>
     ...
     * {@link RecyclerView.Adapter#notifyDataSetChanged()} has been called but the new layout has not been
     ...
     * use an Adapter with {@link RecyclerView.Adapter#setHasStableIds(boolean) stableIds} to
     ...
     * Useful for implementing simple scrolling in {@link RecyclerView.LayoutManager LayoutManagers}.
     *
     ...
     * {@link RecyclerView.LayoutManager} measures or lays out the view and is a good time to perform these
     * changes.</p>
     *
     ...
     * {@link RecyclerView.LayoutManager} fully detaches the child view from the parent and its window.</p>
     *
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (mAdapter != null) {
                    ...
                    RecyclerView.SmoothScroller smoothScroller = mLayout.mSmoothScroller;
     ...
     *
     * @see RecyclerView#setEdgeEffectFactory(RecyclerView.EdgeEffectFactory)
     */
    ...
    public static class RecycledViewPool {
        ...
        public RecyclerView.ViewHolder getRecycledView(int viewType) {
            final RecyclerView.RecycledViewPool.ScrapData scrapData = mScrap.get(viewType);
        ...
        private RecyclerView.RecycledViewPool.ScrapData getScrapDataForType(int viewType) {
            RecyclerView.RecycledViewPool.ScrapData scrapData = mScrap.get(viewType);
            if (scrapData == null) {
    ...
    public final class Recycler {
        ...
        private final List<RecyclerView.ViewHolder>
        ...
        public void bindViewToPosition(@NonNull View view, int position) {
            RecyclerView.ViewHolder holder = getChildViewHolderInt(view);
            if (holder == null) {
         ...
         * views to represent data from an {@link RecyclerView.Adapter}.
         * <p>
         ...
         * returned. Use {@link RecyclerView.ViewHolder#isBound()} on the returned object to check for this.
         *
        ...
        RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int position,
            ...
            Log.d("RecyclerView", "whb tryGetViewHolderForPositionByDeadline() mState.isPreLayout()= "+mState.isPreLayout() +",position="+position);
            ...
            if (holder == null) {
                ...
                Log.d("RecyclerView", "whb tryGetViewHolderForPositionByDeadline() getScrapOrHiddenOrCachedHolder holder="+holder);
                if (holder != null) {
            ...
            if (holder == null) {
                ...
                if (mAdapter.hasStableIds()) {
                    holder = getScrapOrCachedViewForId(mAdapter.getItemId(offsetPosition),
                            type, dryRun);
                    Log.d("RecyclerView", "whb tryGetViewHolderForPositionByDeadline() getScrapOrCachedViewForId holder="+holder);
                    if (holder != null) {
                        // update position
                ...
                if (holder == null && mViewCacheExtension != null) {
                    ...
                    if (view != null) {
                        ...
                        Log.d("RecyclerView", "whb tryGetViewHolderForPositionByDeadline() mViewCacheExtension getViewForPositionAndType holder="+holder);
                        if (holder == null) {
                ...
                if (holder == null) { // fallback to pool
                    ...
                    Log.d("RecyclerView", "whb tryGetViewHolderForPositionByDeadline() getRecycledViewPool holder="+holder);
                    if (holder != null) {
            ...
            if (mState.isPreLayout() && holder.isBound()) {
                ...
                final int offsetPosition = mAdapterHelper.findPositionOffset(position);
                Log.d("RecyclerView", "whb tryGetViewHolderForPositionByDeadline() tryBindViewHolderByDeadline ");
         ...
         * @see RecyclerView.LayoutManager#removeAndRecycleView(View, RecyclerView.Recycler)
         */
        ...
        RecyclerView.ViewHolder getChangedScrapViewForPosition(int position) {
            ...
            for (int i = 0; i < changedScrapSize; i++) {
                final RecyclerView.ViewHolder holder = mChangedScrap.get(i);
                ...
                if (holder.getItemId() == id && !holder.wasReturnedFromScrap()) {
                    if (type == holder.getItemViewType()) {
                        ...
                        if (holder.isRemoved()) {
                            ...
                            // between.
                            if (!mState.isPreLayout()) {
                                holder.setFlags(RecyclerView.ViewHolder.FLAG_UPDATE, RecyclerView.ViewHolder.FLAG_UPDATE
                                        | RecyclerView.ViewHolder.FLAG_INVALID | RecyclerView.ViewHolder.FLAG_REMOVED);
                            }
                        }
                        return holder;
                    } else if (!dryRun) {
            ...
            for (int i = cachedCount - 1; i >= 0; i--) {
                ...
                if (holder != null) {
                    if (holder.mPosition >= removedEnd) {
                        ...
                        holder.addFlags(RecyclerView.ViewHolder.FLAG_REMOVED);
                        recycleCachedViewAt(i);
                    }
                }
            }
     ...
     * <p>
     * When {@link RecyclerView.Recycler#getViewForPosition(int)} is called, Recycler checks attached scrap and
     * first level cache to find a matching View. If it cannot find a suitable View, Recycler will
     * call the {@link #getViewForPositionAndType(RecyclerView.Recycler, int, int)} before checking
    ...
    public abstract static class Adapter<VH extends RecyclerView.ViewHolder> {
         ...
         * {@link RecyclerView.ViewHolder} and initializes some private fields to be used by RecyclerView.
         *
        ...
        /**
         * This method internally calls {@link #onBindViewHolder(RecyclerView.ViewHolder, int)} to update the
         * {@link RecyclerView.ViewHolder} contents with the item at the given position and also sets up some
        ...
        public final void bindViewHolder(@NonNull VH holder, int position) {
            ...
            holder.setFlags(RecyclerView.ViewHolder.FLAG_BOUND,
                    RecyclerView.ViewHolder.FLAG_BOUND | RecyclerView.ViewHolder.FLAG_UPDATE | RecyclerView.ViewHolder.FLAG_INVALID
                            | RecyclerView.ViewHolder.FLAG_ADAPTER_POSITION_UNKNOWN);
         ...
         * {@link #onBindViewHolder(RecyclerView.ViewHolder, int)} call when View is rebound to a new position.
         ...
         * and may be passed to adapter's {@link #onBindViewHolder(RecyclerView.ViewHolder, int, List)} if the
         * item is already represented by a ViewHolder and it will be rebound to the same
         * ViewHolder. A notifyItemRangeChanged() with null payload will clear all existing
         * payloads on that item and prevent future payload until
         * {@link #onBindViewHolder(RecyclerView.ViewHolder, int, List)} is called. Adapter should not assume
    ...
    public abstract static class LayoutManager {
         ...
         * requested by a {@link #collectInitialPrefetchPositions(int, RecyclerView.LayoutManager.LayoutPrefetchRegistry)} or
         * {@link #collectAdjacentPrefetchPositions(int, int, RecyclerView.State, RecyclerView.LayoutManager.LayoutPrefetchRegistry)} call.
         *
         * If expanded by a {@link #collectInitialPrefetchPositions(int, RecyclerView.LayoutManager.LayoutPrefetchRegistry)},
         ...
         *
         * @see RecyclerView.LayoutManager#collectAdjacentPrefetchPositions(int, int, RecyclerView.State, RecyclerView.LayoutManager.LayoutPrefetchRegistry)
         ...
         * {@link RecyclerView.LayoutManager#onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} in the execution of
         ...
         * {@link RecyclerView.LayoutManager#onMeasure(RecyclerView.Recycler, RecyclerView.State, int, int)} should not be overridden.
         * <p>
         ...
         * {@link RecyclerView.LayoutManager#onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} during a call to
         ...
         * {@link RecyclerView.LayoutManager#onMeasure(RecyclerView.Recycler, RecyclerView.State, int, int)} for backwards compatibility
         ...
         * call {@link #onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} with {@link RecyclerView.State#isPreLayout()} set to
         ...
         * {@link #onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} with {@link RecyclerView.State#isMeasuring()} set to
         ...
         * {@link #onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} call as if it is the last one.</li>
         ...
         * that information. It may still decide to call {@link #onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)}
         ...
         * behavioral contracts outlined in {@link #onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)}.
         * <p>
         ...
         * {@link RecyclerView#setItemAnimator(RecyclerView.ItemAnimator) ItemAnimator} set on the
         ...
         * traversals.</p>
         *
         * <p>The LayoutManager should call {@link RecyclerView.LayoutManager.LayoutPrefetchRegistry#addPosition(int, int)} for
         ...
         *
         * @see #isItemPrefetchEnabled()
         * @see #collectInitialPrefetchPositions(int, RecyclerView.LayoutManager.LayoutPrefetchRegistry)
         */
         ...
         *
         * @see #isItemPrefetchEnabled()
         * @see #collectAdjacentPrefetchPositions(int, int, RecyclerView.State, RecyclerView.LayoutManager.LayoutPrefetchRegistry)
         */
         ...
         * multiple {@link #onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} calls due to animations or
        ...
        public RecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
            if (lp instanceof RecyclerView.LayoutParams) {
                ...
                return new RecyclerView.LayoutParams((MarginLayoutParams) lp);
            } else {
        ...
        /**
         * To be called only during {@link #onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} to add a view
         ...
         * recyling. Methods like {@link #removeAndRecycleAllViews(RecyclerView.Recycler)} will ignore the child
         ...
         * {@link RecyclerView#setAdapter(RecyclerView.Adapter)} or
         * {@link RecyclerView#swapAdapter(RecyclerView.Adapter, boolean)}. The LayoutManager may use this
         ...
         * <p>
         * If you want to clean cached views as well, you should call {@link RecyclerView.Recycler#clear()} too.
         * <p>
         * If a View is marked as "ignored", it is not removed nor recycled.
         *
         * @param recycler Recycler to use to recycle children
         * @see #removeAndRecycleView(View, RecyclerView.Recycler)
         * @see #removeAndRecycleViewAt(int, RecyclerView.Recycler)
         * @see #ignoreView(View)
         */
         ...
         * at all. For example, if there is not any {@link RecyclerView.ItemAnimator} set, RecyclerView will
    ...
    public abstract static class ItemDecoration {
        ...
        /**
         * @deprecated
         * Use {@link #getItemOffsets(Rect, View, RecyclerView, RecyclerView.State)}
         */
        @Deprecated
     ...
     * a view is recycled.
     *
     * @see RecyclerView#setRecyclerListener(RecyclerView.RecyclerListener)
     */
    ...
    public abstract static class ViewHolder {
        ...
        void flagRemovedAndOffsetPosition(int mNewPosition, int offset, boolean applyToPreLayout) {
            addFlags(RecyclerView.ViewHolder.FLAG_REMOVED);
     ...
     */
    @VisibleForTesting
    boolean setChildImportantForAccessibilityInternal(RecyclerView.ViewHolder viewHolder,
    ...
    void dispatchPendingImportantForAccessibilityChanges() {
        for (int i = mPendingAccessibilityImportanceChange.size() - 1; i >= 0; i--) {
            RecyclerView.ViewHolder viewHolder = mPendingAccessibilityImportanceChange.get(i);
            if (viewHolder.itemView.getParent() != this || viewHolder.shouldIgnore()) {
                continue;
            }
            int state = viewHolder.mPendingAccessibilityState;
            if (state != RecyclerView.ViewHolder.PENDING_ACCESSIBILITY_STATE_NOT_SET) {
                //noinspection WrongConstant
                ViewCompat.setImportantForAccessibility(viewHolder.itemView, state);
                viewHolder.mPendingAccessibilityState =
                        RecyclerView.ViewHolder.PENDING_ACCESSIBILITY_STATE_NOT_SET;
            }
        }
        mPendingAccessibilityImportanceChange.clear();
    }
    ...
    int getAdapterPositionFor(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(RecyclerView.ViewHolder.FLAG_INVALID
                | RecyclerView.ViewHolder.FLAG_REMOVED | RecyclerView.ViewHolder.FLAG_ADAPTER_POSITION_UNKNOWN)
                || !viewHolder.isBound()) {
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable,
        ...
        new FastScroller(RecyclerView.this, verticalThumbDrawable, verticalTrackDrawable,
                horizontalThumbDrawable, horizontalTrackDrawable,
     ...
     * instance for each call to {@link RecyclerView.LayoutManager#startSmoothScroll(RecyclerView.SmoothScroller)}.
     *
    ...
    public abstract static class SmoothScroller {
        ...
        public SmoothScroller() {
            mRecyclingAction = new RecyclerView.SmoothScroller.Action(0, 0);
        }
         ...
         * {@link #onTargetFound(android.view.View, RecyclerView.State, RecyclerView.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, RecyclerView.State, RecyclerView.SmoothScroller.Action)} until
        ...
        public PointF computeScrollVectorForPosition(int targetPosition) {
            ...
            Log.w(TAG, "You should override computeScrollVectorForPosition when the LayoutManager"
                    + " does not implement " + RecyclerView.SmoothScroller.ScrollVectorProvider.class.getCanonicalName());
            return null;
        }
         ...
         * cancel any existing {@link RecyclerView.SmoothScroller.Action} updated by
         * {@link #onTargetFound(android.view.View, RecyclerView.State, RecyclerView.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, RecyclerView.State, RecyclerView.SmoothScroller.Action)}.
         */
         ...
         * @deprecated Use {@link RecyclerView.SmoothScroller.Action#jumpTo(int)}.
         */
        @Deprecated
         ...
         * provided {@link RecyclerView.SmoothScroller.Action} to define the next scroll.</p>
         *
         ...
         *                  update this object.
         */
        protected abstract void onSeekTargetStep(@Px int dx, @Px int dy, @NonNull RecyclerView.State state,
                                                 @NonNull RecyclerView.SmoothScroller.Action action);

        /**
         * Called when the target position is laid out. This is the last callback SmoothScroller
         * will receive and it should update the provided {@link RecyclerView.SmoothScroller.Action} to define the scroll
         ...
         */
        protected abstract void onTargetFound(@NonNull View targetView, @NonNull RecyclerView.State state,
                                              @NonNull RecyclerView.SmoothScroller.Action action);

        /**
         * Holds information about a smooth scroll request by a {@link RecyclerView.SmoothScroller}.
         */
         ...
         * to provide a hint to a {@link RecyclerView.SmoothScroller} about the location of the target position.
         */
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public static final Creator<RecyclerView.SavedState> CREATOR = new ClassLoaderCreator<RecyclerView.SavedState>() {
            ...
            public RecyclerView.SavedState createFromParcel(Parcel in) {
                return new RecyclerView.SavedState(in, null);
            }
    ...
    public static class State {
         ...
         * its {@link RecyclerView.LayoutManager} layout items where they will be at the beginning of a set of
         ...
         * {@link RecyclerView.LayoutManager#onLayoutChildren(RecyclerView.Recycler, RecyclerView.State)} when this happens.
         *
         ...
         * {@link RecyclerView.LayoutManager} layout items where they will be at the beginning of a set of
         * predictive item animations.
         */
         ...
         * scenes, RecyclerView offsets {@link RecyclerView.Recycler#getViewForPosition(int)} calls such that
         ...
         * <p>
         * You can get the adapter's item count via {@link RecyclerView.LayoutManager#getItemCount()} method.
         *
         * @return The number of items currently available
         * @see RecyclerView.LayoutManager#getItemCount()
         */
        public int getItemCount() {
            return mInPreLayout
     ...
     * <p>
     * Subclasses of {@link RecyclerView.OnFlingListener} can be used to implement custom fling behavior.
     *
     * @see #setOnFlingListener(RecyclerView.OnFlingListener)
     */
    public abstract static class OnFlingListener {

        /**
         * Override this to handle a fling given the velocities in both x and y directions.
         * Note that this method will only be called if the associated {@link RecyclerView.LayoutManager}
     ...
     * are being animated, but implementors must call {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)}
     * when a ViewHolder's animation is finished. In other words, there must be a matching
     * {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} call for each
     * {@link #animateAppearance(RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo) animateAppearance()},
     * {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
     * animateChange()}
     * {@link #animatePersistence(RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo) animatePersistence()},
     * and
     * {@link #animateDisappearance(RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
     * animateDisappearance()} call.
     *
     * <p>By default, RecyclerView uses {@link DefaultItemAnimator}.</p>
     *
     * @see #setItemAnimator(RecyclerView.ItemAnimator)
     */
    ...
    public abstract static class ItemAnimator {
         ...
         * <p>
         * @see #recordPreLayoutInformation(RecyclerView.State, RecyclerView.ViewHolder, int, List)
         */
         ...
         * @see #recordPreLayoutInformation(RecyclerView.State, RecyclerView.ViewHolder, int, List)
         */
        public static final int FLAG_INVALIDATED = RecyclerView.ViewHolder.FLAG_INVALID;
         ...
         * @see #recordPreLayoutInformation(RecyclerView.State, RecyclerView.ViewHolder, int, List)
         */
        public static final int FLAG_MOVED = RecyclerView.ViewHolder.FLAG_MOVED;
        ...
        public static final int FLAG_APPEARED_IN_PRE_LAYOUT =
                RecyclerView.ViewHolder.FLAG_APPEARED_IN_PRE_LAYOUT;
        ...
        private ArrayList<RecyclerView.ItemAnimator.ItemAnimatorFinishedListener> mFinishedListeners =
                new ArrayList<RecyclerView.ItemAnimator.ItemAnimatorFinishedListener>();
         ...
         * <p>
         * The default implementation returns an {@link RecyclerView.ItemAnimator.ItemHolderInfo} which holds the bounds of
         ...
         *
         * @see #recordPostLayoutInformation(RecyclerView.State, RecyclerView.ViewHolder)
         * @see #animateAppearance(RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
         * @see #animateDisappearance(RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
         * @see #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
         * @see #animatePersistence(RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
         */
        public @NonNull
        RecyclerView.ItemAnimator.ItemHolderInfo recordPreLayoutInformation(@NonNull RecyclerView.State state,
                                                                            @NonNull RecyclerView.ViewHolder viewHolder, @RecyclerView.ItemAnimator.AdapterChanges int changeFlags,
                                                                            @NonNull List<Object> payloads) {
         ...
         */
        public @NonNull
        RecyclerView.ItemAnimator.ItemHolderInfo recordPostLayoutInformation(@NonNull RecyclerView.State state,
         ...
         * {@link #canReuseUpdatedViewHolder(RecyclerView.ViewHolder) canReuseUpdatedViewHolder} and the
         ...
         * RecyclerView will call {@link #recordPostLayoutInformation(RecyclerView.State, RecyclerView.ViewHolder)} and the
         * response of that call will be passed to this method as the <code>postLayoutInfo</code>.
         * <p>
         * ItemAnimator must call {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} when the animation
         * is complete (or instantly call {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} if it
         ...
         *                       {@link #recordPostLayoutInformation(RecyclerView.State, RecyclerView.ViewHolder)}. Might be
         *                       null if the LayoutManager did not layout the item.
         *
         * @return true if a later call to {@link #runPendingAnimations()} is requested,
         * false otherwise.
         */
        public abstract boolean animateDisappearance(@NonNull RecyclerView.ViewHolder viewHolder,
         ...
         * false otherwise.
         */
        public abstract boolean animateAppearance(@NonNull RecyclerView.ViewHolder viewHolder,
         ...
         * animate, it should call {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} and return
         * <code>false</code>.
         * <p>
         * ItemAnimator must call {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} when the animation
         * is complete (or instantly call {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} if it
         ...
         * false otherwise.
         */
        public abstract boolean animatePersistence(@NonNull RecyclerView.ViewHolder viewHolder,
                                                   @NonNull RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo);
         ...
         * instead, {@link #animateAppearance(RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)} will be
         ...
         * presentation (see: {@link #canReuseUpdatedViewHolder(RecyclerView.ViewHolder, List)}.
         ...
         * this ViewHolder when {@link #canReuseUpdatedViewHolder(RecyclerView.ViewHolder, List)} was called, the
         ...
         * <p>
         * ItemAnimator must call {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} for each distinct
         * ViewHolder when their animation is complete
         * (or instantly call {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} if it decides not to
         * animate the view).
         * <p>
         *  If oldHolder and newHolder are the same instance, you should call
         * {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} <b>only once</b>.
         * <p>
         * Note that when a ViewHolder both changes and disappears in the same layout pass, the
         * animation callback method which will be called by the RecyclerView depends on the
         * ItemAnimator's decision whether to re-use the same ViewHolder or not, and also the
         ...
         * {@link #animateAppearance(RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
         * animateAppearance()},
         * {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
         * animateChange()}
         * {@link #animatePersistence(RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
         ...
         * Also, {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} should be called for each finished
         ...
         */
        public abstract void endAnimation(@NonNull RecyclerView.ViewHolder item);
         ...
         * should
         * be a matching {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} call by the subclass.
         * <p>
         * For {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
         ...
         * @see #onAnimationFinished(RecyclerView.ViewHolder)
         */
        ...
        /**
         * Called after {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} is called by the
         * ItemAnimator.
         *
         ...
         * @see #dispatchAnimationFinished(RecyclerView.ViewHolder)
         */
         ...
         * {@link #dispatchAnimationStarted(RecyclerView.ViewHolder)} call by the subclass.
         * <p>
         * For {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)
         * animateChange()}, subclass should call this method for both the <code>oldHolder</code>
         * and <code>newHolder</code> (if they are not the same instance).
         ...
         * {@link #dispatchAnimationFinished(RecyclerView.ViewHolder)} <b>without</b> calling
         * {@link #dispatchAnimationStarted(RecyclerView.ViewHolder)}.
         *
         * @param viewHolder The ViewHolder whose animation is starting.
         * @see #onAnimationStarted(RecyclerView.ViewHolder)
         */
         ...
         * @see #dispatchAnimationStarted(RecyclerView.ViewHolder)
         */
         ...
         * <p>
         * Note that this method will only be called if the {@link RecyclerView.ViewHolder} still has the same
         * type ({@link RecyclerView.Adapter#getItemViewType(int)}). Otherwise, ItemAnimator will always receive
         * both {@link RecyclerView.ViewHolder}s in the
         * {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)} method.
         * <p>
         * If your application is using change payloads, you can override
         * {@link #canReuseUpdatedViewHolder(RecyclerView.ViewHolder, List)} to decide based on payloads.
         *
         ...
         *
         * @see #canReuseUpdatedViewHolder(RecyclerView.ViewHolder, List)
         */
         ...
         *         {@link #canReuseUpdatedViewHolder(RecyclerView.ViewHolder)}.
         *
         * @see #canReuseUpdatedViewHolder(RecyclerView.ViewHolder)
         */
        public boolean canReuseUpdatedViewHolder(@NonNull RecyclerView.ViewHolder viewHolder,
                                                 @NonNull List<Object> payloads) {
        ...
        /**
         * Returns a new {@link RecyclerView.ItemAnimator.ItemHolderInfo} which will be used to store information about the
         * ViewHolder. This information will later be passed into <code>animate**</code> methods.
         * <p>
         * You can override this method if you want to extend {@link RecyclerView.ItemAnimator.ItemHolderInfo} and provide
         * your own instances.
         *
         * @return A new {@link RecyclerView.ItemAnimator.ItemHolderInfo}.
         */
        @NonNull
        ...
        interface ItemAnimatorListener {
            void onAnimationFinished(@NonNull RecyclerView.ViewHolder item);
        }
         ...
         *
         * @see #isRunning(RecyclerView.ItemAnimator.ItemAnimatorFinishedListener)
         */
         ...
         * {@link #recordPreLayoutInformation(RecyclerView.State, RecyclerView.ViewHolder, int, List)} and
         * {@link #recordPostLayoutInformation(RecyclerView.State, RecyclerView.ViewHolder)} returns this data
        ...
        public static class ItemHolderInfo {
             ...
             * @return This {@link RecyclerView.ItemAnimator.ItemHolderInfo}
             */
            @NonNull
             ...
             *               {@link #recordPreLayoutInformation(RecyclerView.State, RecyclerView.ViewHolder, int,
             *               List)}.
             * @return This {@link RecyclerView.ItemAnimator.ItemHolderInfo}
             */
            @NonNull
