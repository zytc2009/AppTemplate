...
import com.zy.main.widget.RecyclerView.OnItemTouchListener;
import com.zy.main.widget.RecyclerView.ViewHolder;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     * {@link ItemTouchHelper.Callback#getAbsoluteMovementFlags(RecyclerView, ViewHolder)} for the current
     * action state.
     */
    @SuppressWarnings("WeakerAccess") /* synthetic access */
            int mSelectedFlags;
    ...
    private final OnItemTouchListener mOnItemTouchListener = new OnItemTouchListener() {
        ...
        public boolean onInterceptTouchEvent(@NonNull RecyclerView recyclerView,
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (mSelected == null) {
                    final ItemTouchHelper.RecoverAnimation animation = findAnimation(event);
                    if (animation != null) {
    ...
    private void destroyCallbacks() {
        ...
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final ItemTouchHelper.RecoverAnimation recoverAnimation = mRecoverAnimations.get(0);
    ...
    private void startGestureDetection() {
        mItemTouchHelperGestureListener = new ItemTouchHelper.ItemTouchHelperGestureListener();
    ...
    void select(@Nullable ViewHolder selected, int actionState) {
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                final ItemTouchHelper.RecoverAnimation rv = new ItemTouchHelper.RecoverAnimation(prevSelected, animationType,
     ...
     * {@link ItemTouchHelper.SimpleCallback}.
     * <p>
     * If user drags an item, ItemTouchHelper will call
     * {@link ItemTouchHelper.Callback#onMove(RecyclerView, ViewHolder, ViewHolder)
    ...
    public abstract static class Callback {
        ...
        /**
         * Returns the {@link ItemTouchUIUtil} that is used by the {@link ItemTouchHelper.Callback} class for
         * visual
         ...
         * <p>
         * By default, {@link ItemTouchHelper.Callback} applies these changes on
         ...
         * </pre>
         *
         * @return The {@link ItemTouchUIUtil} instance that is used by the {@link ItemTouchHelper.Callback}
         */
        @SuppressWarnings("WeakerAccess")
        @NonNull
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
         ...
         * {@link ItemTouchHelper.ItemTouchHelperGestureListener#onLongPress(MotionEvent)}.
         *
         ...
         * {@link ItemTouchHelper.ItemTouchHelperGestureListener#onLongPress(MotionEvent)} being called.
         */
