...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state instanceof LinearLayoutManager.SavedState) {
            mPendingSavedState = (LinearLayoutManager.SavedState) state;
            requestLayout();
            if (DEBUG) {
    ...
    protected void calculateExtraLayoutSpace(@NonNull RecyclerView.State state,
        ...
        if (mLayoutState.mLayoutDirection == LinearLayoutManager.LayoutState.LAYOUT_START) {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Log.d("RecyclerView", "whb onLayoutChildren() start");
        ...
        if (!mAnchorInfo.mValid || mPendingScrollPosition != RecyclerView.NO_POSITION
            ...
            Log.d("RecyclerView", "whb onLayoutChildren() updateAnchorInfoForLayout");
        ...
        Log.d("RecyclerView", "whb onLayoutChildren() detachAndScrapAttachedViews()");
        ...
        if (mAnchorInfo.mLayoutFromEnd) {
            Log.d("RecyclerView", "whb onLayoutChildren() fromEnd updateLayoutStateToFillStart()");
            // fill towards start
            ...
            if (mLayoutState.mAvailable > 0) {
                ...
                Log.d("RecyclerView", "whb onLayoutChildren() fromEnd mAvailable updateLayoutStateToFillStart()");
            ...
            Log.d("RecyclerView", "whb onLayoutChildren() fromStart  updateLayoutStateToFillEnd()");
            // fill towards end
            updateLayoutStateToFillEnd(mAnchorInfo);
            mLayoutState.mExtraFillSpace = extraForEnd;
            fill(recycler, mLayoutState, state, false);
            ...
            if (mLayoutState.mAvailable > 0) {
                ...
                Log.d("RecyclerView", "whb onLayoutChildren() fromStart mAvailable updateLayoutStateToFillEnd()");
        ...
        Log.d("RecyclerView", "whb onLayoutChildren() end");
    }
    ...
    void onAnchorReady(RecyclerView.Recycler recycler, RecyclerView.State state,
                       LinearLayoutManager.AnchorInfo anchorInfo, int firstLayoutItemDirection) {
    }
    ...
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler,
        ...
        for (int i = 0; i < scrapSize; i++) {
            ...
            final int direction = position < firstChildPos != mShouldReverseLayout
                    ? LinearLayoutManager.LayoutState.LAYOUT_START : LinearLayoutManager.LayoutState.LAYOUT_END;
            if (direction == LinearLayoutManager.LayoutState.LAYOUT_START) {
    ...
    private void updateLayoutStateToFillEnd(int itemPosition, int offset) {
        ...
        mLayoutState.mLayoutDirection = LinearLayoutManager.LayoutState.LAYOUT_END;
        mLayoutState.mOffset = offset;
        mLayoutState.mScrollingOffset = LinearLayoutManager.LayoutState.SCROLLING_OFFSET_NaN;
    }
    ...
    private void updateLayoutStateToFillStart(int itemPosition, int offset) {
        ...
        mLayoutState.mCurrentPosition = itemPosition;
        mLayoutState.mItemDirection = mShouldReverseLayout ? LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL :
                LinearLayoutManager.LayoutState.ITEM_DIRECTION_HEAD;
        mLayoutState.mLayoutDirection = LinearLayoutManager.LayoutState.LAYOUT_START;
        mLayoutState.mOffset = offset;
        mLayoutState.mScrollingOffset = LinearLayoutManager.LayoutState.SCROLLING_OFFSET_NaN;
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace,
        ...
        int extraForStart = Math.max(0, mReusableIntPair[0]);
        int extraForEnd = Math.max(0, mReusableIntPair[1]);
        boolean layoutToEnd = layoutDirection == LinearLayoutManager.LayoutState.LAYOUT_END;
     ...
     * @return {@link LinearLayoutManager.LayoutState#LAYOUT_START} or {@link LinearLayoutManager.LayoutState#LAYOUT_END} if focus direction
     * is applicable to current state, {@link LinearLayoutManager.LayoutState#INVALID_LAYOUT} otherwise.
     */
    int convertFocusDirectionToLayoutDirection(int focusDirection) {
        switch (focusDirection) {
            case View.FOCUS_BACKWARD:
                if (mOrientation == VERTICAL) {
                    return LinearLayoutManager.LayoutState.LAYOUT_START;
                } else if (isLayoutRTL()) {
                    return LinearLayoutManager.LayoutState.LAYOUT_END;
                } else {
                    return LinearLayoutManager.LayoutState.LAYOUT_START;
                }
            ...
            case View.FOCUS_UP:
                return mOrientation == VERTICAL ? LinearLayoutManager.LayoutState.LAYOUT_START
                        : LinearLayoutManager.LayoutState.INVALID_LAYOUT;
            case View.FOCUS_DOWN:
                return mOrientation == VERTICAL ? LinearLayoutManager.LayoutState.LAYOUT_END
                        : LinearLayoutManager.LayoutState.INVALID_LAYOUT;
            case View.FOCUS_LEFT:
                return mOrientation == HORIZONTAL ? LinearLayoutManager.LayoutState.LAYOUT_START
                        : LinearLayoutManager.LayoutState.INVALID_LAYOUT;
            case View.FOCUS_RIGHT:
                return mOrientation == HORIZONTAL ? LinearLayoutManager.LayoutState.LAYOUT_END
                        : LinearLayoutManager.LayoutState.INVALID_LAYOUT;
            default:
                if (DEBUG) {
                    Log.d(TAG, "Unknown focus request:" + focusDirection);
                }
                return LinearLayoutManager.LayoutState.INVALID_LAYOUT;
        }
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
        ...
        if (layoutDir == LinearLayoutManager.LayoutState.INVALID_LAYOUT) {
            return null;
        }
        ensureLayoutState();
        ...
        if (layoutDir == LinearLayoutManager.LayoutState.LAYOUT_START) {
    ...
    public void prepareForDrop(@NonNull View view, @NonNull View target, int x, int y) {
        ...
        final int dropDirection = myPos < targetPos ? LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL
                : LinearLayoutManager.LayoutState.ITEM_DIRECTION_HEAD;
        if (mShouldReverseLayout) {
            if (dropDirection == LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL) {
            ...
            if (dropDirection == LinearLayoutManager.LayoutState.ITEM_DIRECTION_HEAD) {
    ...
    public static class SavedState implements Parcelable {
        ...
        public static final Parcelable.Creator<LinearLayoutManager.SavedState> CREATOR =
                new Parcelable.Creator<LinearLayoutManager.SavedState>() {
                    @Override
